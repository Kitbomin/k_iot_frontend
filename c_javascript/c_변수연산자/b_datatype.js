...
let value = null;
console.log(value);
console.log(typeof value); // object 모든 타입의 최상위 타입으로 찍힘

console.log(
  // value 변수의 타입 반환 문자열이 'object' 이고 false가 아니면 null
  // >> !value -> value가 false인 경우 -> 값이 존재하지 않는 경우
...
console.log(num1 + num2); // 579가 나오지롱 -> why?
...
// NaN: Not a Number (숫자로 변환할 수 없는 값 변환 시도 시)
// ? 그럼 NaN 타입은 JS엔 없는것인가?
