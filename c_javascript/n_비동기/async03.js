...
//   - 기존의 콜백보다 가독성이 좋음
//   - 아직 결과가 정해지지 않았지만, 미래의 결과를 약속하는 객체임

//! 2. Promise 상태 (3가지)
//  1) 대기 (Pending)
//   : 초기상태, 작업이 아직 완료되지 않음 (비동기 연산이 완료되지 않음)
...
//   : new promise() 생성자 함수를 사용함 
//   - Promise 내부에 콜백함수로 비동기 작업이 완료 되었을 때 후속 동작을 정의
...
// n번째 실행문
  ...
  // >> 비동기 작업을 순서대로 깔끔하게 처리 가능 (콜백 중첩 없이 순서가 명확함)
