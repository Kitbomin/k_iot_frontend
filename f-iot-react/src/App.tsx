...
import Style from './pages/f_style/index'
import { darkTheme, lightTheme } from './practice/d_emotion/theme'
import { ThemeProvider } from '@emotion/react'
import { GlobalStyles } from './practice/d_emotion/Global'
import Dashboard from './practice/d_emotion/Dashboard'
...
function App() {
  ...
  return (
    // <div style={appStyle}>
    <div>
      {/* //? ThemeProvider: 전역 테마를 Emotion 스타일에서 바로 적용 가능 */}
